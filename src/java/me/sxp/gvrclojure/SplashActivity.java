...
public class SplashActivity extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (firstLaunch) {
            firstLaunch = false;
            setupSplash();
            App.loadAsynchronously("me.sxp.gvrclojure.MinGvrActivity",
                                   new Runnable() {
                                       @Override
                                       public void run() {
                                           proceed();
    ...
    public void proceed() {
        startActivity(new Intent("me.sxp.gvrclojure.MAIN"));
        finish();
    }
